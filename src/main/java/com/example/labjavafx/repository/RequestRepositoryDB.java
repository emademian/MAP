...
public class RequestRepositoryDB implements Repository<Request, Long> {
    ...
    public Request findOne(Long aLong) {
        ...
        try (Connection connection = jdbcUtils.getConnection();
            ...
            while (resultSet.next()) {
                ...
                request = new Request(aLong, username1, username2, requestTime, status);
                request.setId(aLong);
            }
    ...
    public Iterable<Request> findAll() {
        ...
        try (Connection connection = jdbcUtils.getConnection();
            ...
            while (resultSet.next()) {
                Long idRequest = resultSet.getLong("id_request");
                String username1 = resultSet.getString("username1");
                String username2 = resultSet.getString("username2");
                LocalDateTime requestTime = resultSet.getTimestamp("request_time").toLocalDateTime();
                String status = resultSet.getString("status");
